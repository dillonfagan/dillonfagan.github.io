    ...
    <main>
      <div className="flex flex-col gap-4 lg:gap-8 items-stretch mx-auto w-screen sm:w-4/5 md:w-2/3 lg:w-3/5 p-4 lg:p-8">
        ...
        <section>
          <Card>
            <Card.Body>
              <Text.Heading h='h2' size='2xl'>Why am I here?</Text.Heading>
              <Text size='xl'>Why would I want to engage with these ideas or enterprises?</Text>
            </Card.Body>
          </Card>
        </section>
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-8">
          <Card>
            <Card.Body>
              <Text.Heading h='h3' size='xl'>PVD Things</Text.Heading>
            </Card.Body>
          </Card>
          <Card>
            <Card.Body>
              <Text.Heading h='h3' size='xl'>Library OS</Text.Heading>
              <Text>
          ...
          <Card>
            <Card.Body>
              <Text.Heading h='h3' size='xl'>Mob app</Text.Heading>
            </Card.Body>
          </Card>
        </section>
      </div>
